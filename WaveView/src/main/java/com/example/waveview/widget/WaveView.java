...
package com.example.waveview.widget;
...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#ffffff");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#ffffff");
